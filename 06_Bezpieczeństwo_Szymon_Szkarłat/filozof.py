...
class DiningPhilosophers:
    def __init__(self, n, typ):
        ...
        # Maksymalnie polowa filozofow moze jesc w tym samym czasie
        self.eating_semaphore = threading.Semaphore(n // 2)
        self.philosophers = [threading.Thread(
            target=self.philosopher, args=(i,)) for i in range(n)]
        self.running = True
